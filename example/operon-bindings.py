...
if __name__ == '__main__':
    ...
    problem.ConfigurePrimitiveSet(Operon.PrimitiveSetConfig([Operon.NodeType.Constant, Operon.NodeType.Variable, Operon.BuiltinOp.Add, Operon.BuiltinOp.Mul, Operon.BuiltinOp.Div, Operon.BuiltinOp.Exp, Operon.BuiltinOp.Log, Operon.BuiltinOp.Sin, Operon.BuiltinOp.Cos]))
