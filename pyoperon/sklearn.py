...
_KNOWN_SYMBOLS: dict[str, Any] = {
    'add'      : op.BuiltinOp.Add,
    'mul'      : op.BuiltinOp.Mul,
    'sub'      : op.BuiltinOp.Sub,
    'div'      : op.BuiltinOp.Div,
    'fmin'     : op.BuiltinOp.Fmin,
    'fmax'     : op.BuiltinOp.Fmax,
    'aq'       : op.BuiltinOp.Aq,
    'pow'      : op.BuiltinOp.Pow,
    'powabs'   : op.BuiltinOp.Powabs,
    'abs'      : op.BuiltinOp.Abs,
    'acos'     : op.BuiltinOp.Acos,
    'asin'     : op.BuiltinOp.Asin,
    'atan'     : op.BuiltinOp.Atan,
    'cbrt'     : op.BuiltinOp.Cbrt,
    'ceil'     : op.BuiltinOp.Ceil,
    'cos'      : op.BuiltinOp.Cos,
    'cosh'     : op.BuiltinOp.Cosh,
    'exp'      : op.BuiltinOp.Exp,
    'floor'    : op.BuiltinOp.Floor,
    'log'      : op.BuiltinOp.Log,
    'logabs'   : op.BuiltinOp.Logabs,
    'log1p'    : op.BuiltinOp.Log1p,
    'sin'      : op.BuiltinOp.Sin,
    'sinh'     : op.BuiltinOp.Sinh,
    'sqrt'     : op.BuiltinOp.Sqrt,
    'sqrtabs'  : op.BuiltinOp.Sqrtabs,
    'tan'      : op.BuiltinOp.Tan,
    'tanh'     : op.BuiltinOp.Tanh,
    'square'   : op.BuiltinOp.Square,
