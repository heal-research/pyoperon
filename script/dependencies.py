...
if __name__ == '__main__':
    ...
    dependencies = [
        ...
        ('operon', 'https://github.com/heal-research/operon', 'd61770c6728cfaae69d555716fab06f0b992ffd7', default_cmake_args + ['--preset', operon_build_preset, '-DBUILD_CLI_PROGRAMS=OFF', '-DBUILD_SHARED_LIBS=OFF', '-DCMAKE_POSITION_INDEPENDENT_CODE=ON']),
    ]
