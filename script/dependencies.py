...
if __name__ == '__main__':
    ...
    dependencies = [
        ...
        ('operon', 'https://github.com/heal-research/operon', '5ae428d7341b9604a160f056fb3dc9f755282843', default_cmake_args + ['--preset', operon_build_preset, '-DBUILD_CLI_PROGRAMS=OFF', '-DBUILD_SHARED_LIBS=OFF', '-DCMAKE_POSITION_INDEPENDENT_CODE=ON']),
    ]
