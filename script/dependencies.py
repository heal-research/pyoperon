...
if __name__ == '__main__':
    ...
    dependencies = [
        ...
        ('operon', 'https://github.com/heal-research/operon', 'f7b1fe5af012ef71bae8392d054851b38c30562c', default_cmake_args + ['--preset', operon_build_preset, '-DBUILD_CLI_PROGRAMS=OFF', '-DBUILD_SHARED_LIBS=OFF', '-DCMAKE_POSITION_INDEPENDENT_CODE=ON']),
    ]
