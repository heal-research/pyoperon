...
if __name__ == '__main__':
    ...
    dependencies = [
        ...
        ('infix-parser', 'https://github.com/foolnotion/infix-parser', 'a423216ed6aa329c2989b2e8686c75faab46ee66', default_cmake_args + ['-DBUILD_SHARED_LIBS=ON']),
        ...
        ('lbfgs', 'https://github.com/foolnotion/lbfgs', '2ccd9d9c173bec3b3ecd9580f3988ea9148dfeba', default_cmake_args),
        ...
        ('operon', 'https://github.com/heal-research/operon', 'ff65713aa60e2c0b6cddf2d6a2a44cfb2f09b82c', default_cmake_args + ['--preset', operon_build_preset, '-DBUILD_CLI_PROGRAMS=OFF', '-DBUILD_SHARED_LIBS=OFF', '-DCMAKE_POSITION_INDEPENDENT_CODE=ON']),
    ]
